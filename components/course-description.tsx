...
export function CourseDescription({
  ...
  const descriptionItems = [
    ...
    },
    {
      ...
      text:
        lang === "bn"
          ...
          : "Strategies to achieve 7+ band score",
    },
    {
      icon: Users,
      ...
      text:
        lang === "bn"
          ? "অভিজ্ঞ ইন্সট্রাক্টরের সাথে শিখুন"
          : "Learn with experienced instructor",
    },
    {
      icon: Clock,
      ...
      text:
        lang === "bn"
          ? "নিজের সুবিধামতো সময়ে কোর্স করুন"
    ...
    },
    {
      ...
      text:
        lang === "bn"
          ? "হাজারো শিক্ষার্থীর সফলতার গল্প"
          : "Success stories of thousands of students",
    },
    {
      icon: Globe,
      ...
      text:
        lang === "bn"
          ? "বিশ্বমানের শিক্ষা পদ্ধতি"
          : "World-class education methodology",
    },
  ];
    ...
    <section className="bg-white rounded-lg p-8 shadow-sm border border-slate-200">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h2 className="text-2xl font-bold text-slate-800">
          {lang === "bn" ? "কোর্স সম্পর্কে" : "About This Course"}
        </h2>
      </div>
