...
export function CourseFeatures({ features, lang }: CourseFeaturesProps) {
  ...
  const featureTranslations = {
    en: {
      ...
      "১০টি লিখিত এবং ১০টি শিলনীর মক টেস্ট": "10 written and 10 listening mock tests",
    ...
    bn: {
      ...
      "10 written and 10 listening mock tests": "১০টি লিখিত এবং ১০টি শিলনীর মক টেস্ট",
        ...
        {features.map((feature, index) => (
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">{translateText(feature.subtitle)}</p>
            </div>
          </div>
        ))}
      </div>
